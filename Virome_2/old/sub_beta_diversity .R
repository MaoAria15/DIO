...
set.seed(19950915)
ps <- subset_samples(PSV.no.Realm.CSS, Treatment %in% c("Unmodified_FVT","Obese_control","Lean_control"))
...
desired_order <- c("Unmodified_FVT_Non_Response","Unmodified_FVT_Response","Obese_control_Non_Response","Obese_control_Response","Lean_control_Non_Response")
Method="bray"
#############################stat###########################################
#1 Arrival
...
t_arrival <- data.frame(Group1=c("Obese_control_Response","Obese_control_Response","Obese_control_Response","Obese_control_Response"),
