...
tab_FVTN_all <- read.table("Bacteriome/stat_result/desep2-sub/Unmodified_FVT_Non_Response_HFD.tsv", sep = "\t",header = T, row.names = 1)
tab_FVT_all <- read.table("Bacteriome/stat_result/desep2-sub/Unmodified_FVT_Response_HFD.tsv", sep = "\t", header = T, row.names = 1)
tab_HFDN_all <- read.table("Bacteriome/stat_result/desep2-sub/Obese_control_Non_Response_HFD.tsv", sep = "\t",header = T, row.names = 1)
tab_LFD_all <- read.table("Bacteriome/stat_result/desep2-sub/Lean_control_Non_Response_HFD.tsv", sep = "\t", header = T, row.names = 1)
