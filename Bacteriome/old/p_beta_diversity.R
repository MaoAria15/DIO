...
t_arrival <- data.frame(Group1=c( "Obese_control","Obese_control","Obese_control","Obese_control","Obese_control"),
                        Group2=c("Lean_control","FVT_SDT","FVT_ChP","Unmodified_FVT","FVT_PyT"),
                        R2= round(r,digits = 3),
                        p=round(p,digits = 3),
...
p_treatment.adj <- c("_",p_treatment.adj)
t_beforefvt <- data.frame(Group1=c( "Obese_control","Obese_control","Obese_control","Obese_control","Obese_control"),
                         Group2=c("Lean_control","FVT_SDT","FVT_ChP","Unmodified_FVT","FVT_PyT"),
                         R2= round(r,digits = 3),
                         p=round(p,digits = 3),
                         p.adj=p_treatment.adj)
...
p_treatment.adj <- c("_",p_treatment.adj)
t_afterfvt <- data.frame(Group1=c( "Obese_control","Obese_control","Obese_control","Obese_control","Obese_control"),
                         Group2=c("Lean_control","FVT_SDT","FVT_ChP","Unmodified_FVT","FVT_PyT"),
                         R2= round(r,digits = 3),
                         p=round(p,digits = 3),
                         p.adj=p_treatment.adj)
...
p_treatment.adj <- c("_",p_treatment.adj)
t_termination <- data.frame(Group1=c( "Obese_control","Obese_control","Obese_control","Obese_control","Obese_control"),
                            Group2=c("Lean_control","FVT_SDT","FVT_ChP","Unmodified_FVT","FVT_PyT"),
                            R2= round(r,digits = 3),
                            p=round(p,digits = 3),
                            p.adj=p_treatment.adj)
...
#  )
# 
#  write_xlsx(sheets, "stat_result/beta_permanova_all.xlsx")
#  
#  sheet2 <- list(
...
#  )
#  
#  write_xlsx(sheet2, "stat_result/beta_permanova_pairs.xlsx")
